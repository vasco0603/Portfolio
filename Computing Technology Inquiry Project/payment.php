    ...
    <section id="enquirebody">
        <h2 class="enquirehead">Customer Details</h2><hr>
            ...
            <div id="Personal_Details_Section" class="leftele">
                ...
                <textarea name="commentfield" id="commentfield" placeholder="Type enquiry details here"></textarea></h3>
            </div>
            ...
            <div id="Shipping_Address_Section" class="leftele">
                ...
                <!--Street field-->
                <h3><label for="street">Street</label><br><input type="text" maxlength="40" placeholder="Street" required="required" id="street" name="street"></h3>

                <!--Town field-->
                <h3><label for="town">Suburb/Town</label><br>
                <input type="text" name="town" id="town" maxlength="20" required="required" placeholder="Town"></h3>
                ...
                <!--State & Post code field-->
                    <div class="flex_box">
                        ...
                        <input type="text" placeholder="0000" name="postcode" id="postcode" required="required" pattern="d{4}"></h3>
                        </div>
                    </div>

                <!--Number field-->
                <div id="phonenumber">
                <h3><label for="number">Phone Number</label><br>
                <input type="text" placeholder="### ### ####" name="number" id="number" required="required" pattern="\(\d{2}\) +\d{4}-\d{4}"></h3>
                </div>
                ...
                <fieldset class="enquirefieldset">
                    ...
                    <label for="preferemail"><input type="radio" value="email" name="preferredcontact" checked="checked" id="preferemail">Email</label>
                    <label for="preferpost"><input type="radio" value="post" name="preferredcontact" id="preferpost">Post</label>
            ...
            <div id="Product_Section" class="leftele">
                ...
                <select name="producttypeenquire" id="producttypeenquire">
                    <option value="Compact Camera" selected="selected">Compact Cameras</option>
                ...
                <select name="productidenquire" id="productidenquire">
                    <option value="1" selected="selected">Canon Powershot G7X Mark III Digital Camera ($905)</option>
                ...
                <h3><label for="productquantity">Quantity</label><br>
                <input type="text" name="productquantity" id="productquantity" maxlength="2" size="2" value="1"/></h3>
            ...
            <div id="Payment_Section" class="rightele">
                ...
                <div class="flex_box">
                    <div class="flex_item">
                        <h3><label for="cardexp">Card Exp</label><br>
                        <input type="text" name="cardexp" id="cardexp" required="required" pattern="\d{1,2}\/\d{1,2}\"  placeholder="mm/yy"></h3>
                    </div>
                    <div class="flex_item">
                        <h3><label for="cardcvv">Card CVV</label><br>
                        <input type="text" name="cardcvv" id="cardcvv" required="required" pattern="\d{1,2}\/\d{1,2}\"  placeholder="000"></h3>
                    </div>
                </div>
            </div>
