...
class GameWindow < Gosu::Window
  ...
  def initialize
    #shape_x = Gosu::Image.new(Circle.new(50))
    #shape_x.draw(475, 50, ZOrder::TOP, 1.0, 1.0, 0xff_ffff00)
    super(200, 135, false)
  ...
  def draw
    ...
    Gosu.draw_rect(@shape_x, 30, 20, 30, 0xff_990000, z = ZOrder::TOP, mode = :default)
    puts("2. In draw\n")
  end
end
